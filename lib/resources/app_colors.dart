...
class AppColors {
  ...
  static const Color black = Color.fromARGB(0, 255, 255, 255);
  static Color iconColor = const Color(0xffffffff);

  // static Color goldenYellow = const Color.fromARGB(255, 255, 254, 2);
  // static Color goldUCLA = const Color.fromARGB(255, 255, 182, 6);
}
